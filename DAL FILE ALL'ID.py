...
data_file_path = "C:\\Users\\AndreaFumagalli\\OneDrive - ITS Angelo Rizzoli\\Desktop\\Project Work\\JSON DATASET.txt"  # Replace with your actual file path (ensure backslashes are escaped)
